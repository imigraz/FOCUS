...
class nnUNetTrainerFeatureRehearsalNoSkips(nnUNetTrainerMultiHead):
    ...
    def __init__(self, split, task, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 ...
                 #custom args
                 target_type: FeatureRehearsalTargetType = FeatureRehearsalTargetType.DISTILLED_OUTPUT,
                 ...
                 ViT_task_specific_ln=False, do_LSA=False, do_SPT=False, network=None, use_param_split=False, seed=42):
    ...
    def store_features(self, task):
        ...
        with torch.no_grad():
            ...
            dataset = FeatureRehearsalDataset(join(self.trained_on_path, self.extension,  FEATURE_PATH), self.deep_supervision_scales, self.target_type, num_features, load_skips=False)
