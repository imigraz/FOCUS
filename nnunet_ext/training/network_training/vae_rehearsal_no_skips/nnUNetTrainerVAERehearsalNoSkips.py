...
from nnunet_ext.network_architecture.VAE import CFullyConnectedVAE2, CFullyConnectedVAE2Distributed
...
class nnUNetTrainerVAERehearsalNoSkips(nnUNetTrainerVAERehearsalBase2):
