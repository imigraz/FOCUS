...
from nnunet_ext.training.network_training.feature_rehearsal_dm.nnUNetTrainerFeatureRehearsalDynamicMemory import \
    nnUNetTrainerFeatureRehearsalDynamicMemory
...
class nnUNetTrainerFeatureRehearsalDynamicMemoryGIN(nnUNetTrainerFeatureRehearsalDynamicMemory):
    # -- Trains n tasks sequentially using transfer learning -- #
    def __init__(self, split, task, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, save_interval=5, already_trained_on=None, use_progress=True,
                 identifier=default_plans_identifier, extension='feature_rehearsal_dm_GIN', tasks_list_with_char=None,
