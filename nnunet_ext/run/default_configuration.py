...
def get_default_configuration(network, task, running_task, network_trainer, tasks_joined_name, plans_identifier=default_plans_identifier,
                              search_in=None, base_module=None, extension_type='multihead', print_loss_info=True, param_search=False, exp_name=False):
    ...
    output_folder_name += datetime.now().strftime("_%d.%m.%Y_%H:%M:%S")
